...
if (!isset($_SESSION['pending_registration'])) {
    header('Location: ' . app_path('auth/register.php'));
    exit;
}
...
if (time() - $pendingReg['created_at'] > 600) {
    ...
    header('Location: ' . app_path('auth/register.php') . '?error=expired');
    exit;
}
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <div class="login-footer">
                <p><a href="<?php echo htmlspecialchars(app_path('auth/register.php'), ENT_QUOTES, 'UTF-8'); ?>">Back to Registration</a></p>
            </div>
        </div>
    </div>

    <script type="module" src="frontend/src/pages/auth/verifyEmail.js"></script>
</body>
</html>
