...
<body>
        ...
        <div class="orders-table-container">
            ...
            <?php if (empty($orders)): ?>
                <div class="empty-orders">
                    ...
                    <a href="<?php echo htmlspecialchars(app_path('orders/create-order.php'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary new-order-btn">Create New Order</a>
                </div>
            <?php else: ?>
                ...
                <div class="orders-table-footer">
                    <a href="<?php echo htmlspecialchars(app_path('orders/create-order.php'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Create New Order</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script type="module" src="frontend/src/pages/orders/myOrders.js"></script>
</body>
</html>
